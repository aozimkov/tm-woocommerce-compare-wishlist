...
Tags: woocommerce, ecommerce, e-commerce, store, sales, sell, shop, compare, wishlist
...
TM WooCommerce Compare & Wishlist allows you to compare products on your store, based on WooCommerce plugin and add them to your Wishlist correspondingly.

== Description ==

You need to have a working installation of [WooCommerce](https://wordpress.org/plugins/woocommerce/) on your site in order for the plugin to work correctly.

[Documentation](http://documentation.templatemonster.com/index.php?project=tm-comparewishlist)
...
* Fix wishlist compatibility
* Update install script

= 1.0.1 =

* Fix compare table in Safari on Mac
* Fix incorrect product data in compare table
* Fix number of products on wishlist page
